...
class AppConfig:
    ...
    # Styles
    MAIN_STYLE = "background-color: #0d2538; color: white; font-size: 13px;"
    TOAST_STYLE = """
        QWidget { background-color: #0d2538; border: 1px solid rgba(0,227,150,.6); border-radius: 8px; }
...
class TTSTab(UIToolbarTab):
    ...
    def _setup_ui(self):
        ...
        self.append_history("Xin chào, tôi là trợ lý AI", meta={"demo": True, "priority": "high"})
        self.append_history("Hôm nay thời tiết thế nào?", meta={"demo": True, "priority": "normal"})
    ...
    def _on_convert_clicked(self):
        ...
        self.append_history(text, meta={"type": "TTS", "timestamp": datetime.now().isoformat()})
